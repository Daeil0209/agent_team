...
- Before calling runtime-management controls, verify that the target state does not already exist. Redundant activation calls and avoidable runtime errors are lead-side defects.
