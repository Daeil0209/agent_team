...
LEDGER_LINE="$(REPORT_TIMESTAMP="$TIMESTAMP" REPORT_SESSION_ID="$SESSION_ID" REPORT_SENDER_NAME="$SENDER_NAME" REPORT_TEAM_NAME="$TEAM_NAME" REPORT_AGENT_TYPE="$AGENT_TYPE" REPORT_TASK_ID="$TASK_ID" REPORT_TASK_ID_FIELD_PRESENT="$TASK_ID_FIELD_PRESENT" REPORT_TASK_SUBJECT="$TASK_SUBJECT" REPORT_MESSAGE_CLASS="$MESSAGE_CLASS" REPORT_REQUESTED_LIFECYCLE="$REQUESTED_LIFECYCLE" REPORT_OUTPUT_SURFACE="$OUTPUT_SURFACE" REPORT_EVIDENCE_BASIS="$EVIDENCE_BASIS" REPORT_OPEN_SURFACES="$OPEN_SURFACES" REPORT_NEXT_LANE="$NEXT_LANE" REPORT_PLANNING_BASIS="$PLANNING_BASIS" REPORT_SV_PLAN_VERIFY="$SV_PLAN_VERIFY" REPORT_SELF_VERIFICATION="$SELF_VERIFICATION" REPORT_CONVERGENCE_PASS="$CONVERGENCE_PASS" REPORT_PLANNING_BASIS_VALUE="$PLANNING_BASIS_VALUE" REPORT_SV_PLAN_VERIFY_VALUE="$SV_PLAN_VERIFY_VALUE" REPORT_SELF_VERIFICATION_VALUE="$SELF_VERIFICATION_VALUE" REPORT_CONVERGENCE_PASS_VALUE="$CONVERGENCE_PASS_VALUE" node <<'NODE'
const line = {
