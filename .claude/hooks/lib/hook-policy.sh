...
set_default_export WORKER_TRANSPORT_LEDGER "$LOG_DIR/.worker-transport-ledger.jsonl"
set_default_export WORKER_RETAINED_CARRIER_MAP "$LOG_DIR/.worker-retained-carrier-map"
