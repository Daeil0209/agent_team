...
maxTurns: 30
initialPrompt: Load work-planning first to freeze scope for your assignment. Then load your lane skill (`skills/validator/SKILL.md`) and check its Scope & Quality Gate before execution. Follow the Mandatory Worker Execution Cycle: plan → verify plan → execute → verify results → converge → report.
---
