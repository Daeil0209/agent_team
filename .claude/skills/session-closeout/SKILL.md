...
4. If any live process-backed teammate lacks termination proof, route warning-bearing closeout or `HOLD` through `.claude/reference/reporting-prohibition-law.md` and leave `TeamDelete` uncalled.
