...
> **Note:** RFP labels are code-quality-review-local refactoring priorities. They do not map to the T0-T3 severity framework used by security-review/reference.md.
