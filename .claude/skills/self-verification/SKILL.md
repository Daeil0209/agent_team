...
Missing, stale, unsplit, invalid-enum, theme-level-only, missing-counterexample-oracle, untested-stronger-narrower-alternative, contradicted, or open `CAUSE-REMEDY-CLASSIFICATION` entries fail PASS-2 as cause-remedy-classification gap and route to Step 5.
