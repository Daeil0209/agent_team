...
Reference checklists, tables, and catalogs for the code-quality skill.
...
> **Note:** RFP labels are code-quality-local refactoring priorities. They do not map to the shared T0-T3 governance severity framework in CLAUDE.md.
