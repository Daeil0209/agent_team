...
### Reference Map
Load the narrowest reference matching the document type or reader job; load multiple when frozen document has multiple material jobs.
...
- `references/review-analysis-report.md`: risk analysis, condition review, and go/no-go persuasion structure.
- `references/reader-density-application.md`: information density, practical application tools, and reader preparation; load when document must serve fast executive reading, field reuse, or practical decision support.
...
Evidence acquisition, domain validation, visual composition, and final acceptance stay with their adjacent owner surfaces.
## Identity
