...
- In self-growth and capability-hardening work, prefer benchmark-first thinking. Do not wait for an operator to say "benchmark" if the active claim depends on before/after comparison, ownership contest, promotion, or defense against a leaner neighboring path.
  This proactive activation applies during Self-Growth Sequence contexts only. For production work, activation requires explicit operator request or team-lead SKILL-AUTH per the activation criteria below.
...
> For Capability-Benchmark Standard, see reference.md

> For Runnable Benchmark Path, see reference.md
...
> For Team Selection Protocol, see reference.md

> For Workflow-Structure Benchmark Extension, see reference.md

> For Coupled-Core Benchmark Extension, see reference.md

> For Workflow-Product Benchmark Extension, see reference.md
...
Apply `CLAUDE.md` `Training And Self-Growth Governance`.
