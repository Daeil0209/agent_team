...
- Internal rubrics, binding surfaces, shard manifests, retained carriers, and assignment payload content must not be exposed through assistant-authored prose or write-tool preview rendering; materialize full detail through a non-rendered carrier path and verify it with quiet read-class checks.
