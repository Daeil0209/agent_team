...
| **Default team size** | 1-2 agents | 2 agents maximum | Cap-aware precision deployment: use up to `ACTIVE-CONCURRENT-AGENT-CAP`; split into sub-batches when more than 2 lanes are useful; never exceed the standing operator maximum of 2 concurrent team-scoped lane agents |
