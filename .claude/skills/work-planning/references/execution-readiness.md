...
- team-runtime route basis from `team-runtime-fit.md`; use an explicit lead-local evidence-only direct-Agent basis outside team runtime only when no configured lane, assignment-grade lane, independent specialist separation, receipt, reuse, monitoring, or completion handoff is frozen
