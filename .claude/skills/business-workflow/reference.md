...
For document generation pipeline architecture, refer to document-automation reference.md and software-architecture reference.md § Constraint-Satisfaction Document Generator Architecture Extension. business-workflow owns the business rules and state machine for the proposal domain.
...
For document generation pipeline architecture, refer to document-automation reference.md. business-workflow owns the business rules and generation levels for the result report domain.
