...
- Skill name is `agent-team-lead`; `team-lead` remains a role name, not a skill name.
...
- Ordinary lead procedure detail stays in this skill's references; always-loaded role identity, authority, and high-level trigger order stay in `.claude/agents/team-lead.md`.
