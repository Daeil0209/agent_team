...
- The most important forbidden combinations are: `research + main-body draft`, `broad research + merge-compress`, `audit/evidence/review + governance patch execution`, `draft + final acceptance review`, and `review + validation verdict` in one agent prompt.
