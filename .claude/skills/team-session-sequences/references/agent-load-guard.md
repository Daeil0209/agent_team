...
If a dispatch mixes boundaries, decompose it before sending. Exception: researcher assignments requiring `deep-evidence` coverage receive broader file scope when cross-file pattern discovery is required, but the question surface must stay coherent.
