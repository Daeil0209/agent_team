...
- `governance or quality hardening`: reusable review, validation, migration, or operational-discipline procedure with no current owner

The category gate fails when the proposal is primarily:
