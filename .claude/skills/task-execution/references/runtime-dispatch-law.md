...
- Assignment `TaskCreate` runs only inside the active team task namespace, and assignment carriers are finalized only after the returned team task id is verified.
