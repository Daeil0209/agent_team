# self-growth-sequence: Benchmark Protocol Detail
...
- External-tool capability promotion claims require measured benefit on the relevant route, explicit authority/footprint delta, and a rollback or fail-open path before the capability can move from guidance use to blocking, SV-stage, worker-lane, or automation use.
...
- Passed loss-risk gate opens bounded modification.
- Verified modification opens bounded optimization decision.
- Capability promotion claim opens measured benefit and rollback/fail-open review.
