...
For failure-mode-specific allowed/prohibited responses (non-compliance, weak-owner, wrong-owner, capability-gap, recurrence), consume `references/failure-mode-response.md`.
