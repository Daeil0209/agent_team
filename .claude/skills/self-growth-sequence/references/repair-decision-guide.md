...
3. Deterministic runtime evidence with low false-positive risk allows hook/settings enforcement, subject to two preconditions:
   - the semantic owner is already correct
   - non-hook adherence hardening is insufficient
   Otherwise keep the barrier in doctrine, checklist, packet, self-verification, or owner-surface instructions.
...
- One-off need returns to owner-surface instructions or packet correction.
