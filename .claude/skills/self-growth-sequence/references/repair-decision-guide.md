...
1. If the correct rule already exists and the failure was non-compliance, do not add duplicate doctrine. Harden the trigger, checklist, packet field, or self-verification catch that makes the existing rule harder to miss.
