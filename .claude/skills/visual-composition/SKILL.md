...
Report in conversation. Required elements: surface inventory with declared role, layout rules, dense-state risks, blocking defects, retest conditions, and downstream acceptance state.
## Handoff Boundary
