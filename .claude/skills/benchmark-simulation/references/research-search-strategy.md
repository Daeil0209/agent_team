...
7. Stop only by explicit rule: branch saturation, citation fixed point, enough convergent evidence for the decision threshold, bounded burden-exceeds-value with lower-confidence/open-evidence-risk record, or `HOLD` with residual miss-risk.
