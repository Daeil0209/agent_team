...
- Internal `Bash` stdout or stderr that can render to the terminal is a display-output surface; `.claude/reference/reporting-prohibition-law.md` owns admission, and this section owns the executable runtime/tool-output mechanics.
