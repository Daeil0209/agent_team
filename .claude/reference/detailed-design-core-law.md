...
- `.claude/reference/detailed-scope-continuity-change-law.md`: load when scope-abuse signals, drift, preservation, redistribution, migration, or current-session continuity are material.
