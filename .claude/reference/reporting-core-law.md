...
- `team-lead` owns every user-facing report attempt, including ordinary assistant message or pane prose, and consumes both laws in order before drafting admitted prose.
