...
- Candidate rows close only when promoted, rejected by current review basis, excluded by explicit user-accepted out-of-scope basis, or deferred by cited lawful owner-deferral authority; promotion rows close only when promoted, rejected by current review basis, or deferred by cited lawful owner-deferral authority; patch-loop rows close only when applied and verified, rejected by current review basis, or deferred by cited lawful owner-deferral authority. Any unresolved or blocked row routes claims depending on that row to verdict `HOLD` or blocker-routing with the smallest executable correction owner/action.
